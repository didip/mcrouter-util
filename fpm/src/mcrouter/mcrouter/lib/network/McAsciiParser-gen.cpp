...
#line 1 "lib/network/McAsciiParser.rl"
/*
...
#line 170 "lib/network/McAsciiParser.rl"


// McGet reply.

#line 42 "lib/network/McAsciiParser-gen.cpp"
...
#line 180 "lib/network/McAsciiParser.rl"
...
#line 58 "lib/network/McAsciiParser-gen.cpp"
	{
	}

#line 62 "lib/network/McAsciiParser-gen.cpp"
	{
	if ( ( p_) == ( pe_) )
		goto _test_eof;
	if ( ( savedCs_) == 0 )
...
f22:
#line 43 "lib/network/McAsciiParser.rl"
	{
  ...
  if (remainingIOBufLength_) {
	...
	goto _again;
f4:
#line 72 "lib/network/McAsciiParser.rl"
	{
  if (reply.valueData_) {
	...
	goto _again;
f7:
#line 96 "lib/network/McAsciiParser.rl"
	{
  ...
  {( p_)++; goto _out; }
	...
	goto _again;
f19:
#line 106 "lib/network/McAsciiParser.rl"
	{
  currentUInt_ = currentUInt_ * 10 + ((*( p_)) - '0');
}
	goto _again;
f18:
#line 111 "lib/network/McAsciiParser.rl"
	{
  reply.setFlags(currentUInt_);
}
	goto _again;
f21:
#line 115 "lib/network/McAsciiParser.rl"
	{
  remainingIOBufLength_ = static_cast<size_t>(currentUInt_);
}
	goto _again;
f16:
#line 140 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_found); }
	goto _again;
f11:
#line 148 "lib/network/McAsciiParser.rl"
	{
  ...
  {( p_)++; goto _out; }
	...
	goto _again;
f15:
#line 158 "lib/network/McAsciiParser.rl"
	{
	...
	goto _again;
f6:
#line 167 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_client_error); }
	goto _again;
f0:
#line 177 "lib/network/McAsciiParser.rl"
...
#line 43 "lib/network/McAsciiParser.rl"
  ...
  if (remainingIOBufLength_) {
	...
	goto _again;
f9:
#line 132 "lib/network/McAsciiParser.rl"
	{
...
#line 96 "lib/network/McAsciiParser.rl"
  ...
  {( p_)++; goto _out; }
	...
	goto _again;
f1:
#line 89 "lib/network/McAsciiParser.rl"
	{
  reply.valueData_.clear();
}
#line 154 "lib/network/McAsciiParser.rl"
	{ stripped_ = false; }
#line 72 "lib/network/McAsciiParser.rl"
	{
  if (reply.valueData_) {
...
#line 190 "lib/network/McAsciiParser.rl"

}

// McGets reply.

#line 802 "lib/network/McAsciiParser-gen.cpp"
...
#line 201 "lib/network/McAsciiParser.rl"
...
#line 818 "lib/network/McAsciiParser-gen.cpp"
	{
	}

#line 822 "lib/network/McAsciiParser-gen.cpp"
	{
	if ( ( p_) == ( pe_) )
		goto _test_eof;
	if ( ( savedCs_) == 0 )
...
#line 115 "lib/network/McAsciiParser.rl"
  ...
  remainingIOBufLength_ = static_cast<size_t>(currentUInt_);
	...
	goto _again;
f22:
#line 119 "lib/network/McAsciiParser.rl"
	{
...
#line 167 "lib/network/McAsciiParser.rl"
	...
	goto _again;
f0:
#line 198 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_notfound); }
	goto _again;
f17:
#line 106 "lib/network/McAsciiParser.rl"
...
#line 211 "lib/network/McAsciiParser.rl"

}

// McLeaseGet reply.

#line 1584 "lib/network/McAsciiParser-gen.cpp"
...
#line 228 "lib/network/McAsciiParser.rl"
...
#line 1600 "lib/network/McAsciiParser-gen.cpp"
	{
	}

#line 1604 "lib/network/McAsciiParser-gen.cpp"
	{
	if ( ( p_) == ( pe_) )
		goto _test_eof;
	if ( ( savedCs_) == 0 )
...
#line 115 "lib/network/McAsciiParser.rl"
  ...
  remainingIOBufLength_ = static_cast<size_t>(currentUInt_);
	...
	goto _again;
f12:
#line 127 "lib/network/McAsciiParser.rl"
	{
...
#line 167 "lib/network/McAsciiParser.rl"
	...
	goto _again;
f17:
#line 222 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_notfound); }
	goto _again;
f11:
#line 106 "lib/network/McAsciiParser.rl"
...
#line 238 "lib/network/McAsciiParser.rl"

}

// McStorage reply.

#line 2466 "lib/network/McAsciiParser-gen.cpp"
...
#line 255 "lib/network/McAsciiParser.rl"


void McAsciiParser::consumeStorageReplyCommon(folly::IOBuf& buffer) {
  McReply& reply = currentMessage_.get<McReply>();
  
#line 2480 "lib/network/McAsciiParser-gen.cpp"
	{
	}

#line 2484 "lib/network/McAsciiParser-gen.cpp"
	{
	if ( ( p_) == ( pe_) )
		goto _test_eof;
	if ( ( savedCs_) == 0 )
...
#line 96 "lib/network/McAsciiParser.rl"
  ...
  {( p_)++; goto _out; }
	...
	goto _again;
f13:
#line 137 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_notfound); }
	goto _again;
f10:
#line 138 "lib/network/McAsciiParser.rl"
...
#line 167 "lib/network/McAsciiParser.rl"
	...
	goto _again;
f20:
#line 246 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_stored); }
	goto _again;
f19:
#line 247 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_stalestored); }
	goto _again;
f14:
#line 248 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_notstored); }
	goto _again;
f12:
#line 249 "lib/network/McAsciiParser.rl"
...
#line 263 "lib/network/McAsciiParser.rl"

}

// McArithm reply.

#line 3232 "lib/network/McAsciiParser-gen.cpp"
...
#line 275 "lib/network/McAsciiParser.rl"


void McAsciiParser::consumeArithmReplyCommon(folly::IOBuf& buffer) {
  McReply& reply = currentMessage_.get<McReply>();
  
#line 3246 "lib/network/McAsciiParser-gen.cpp"
	{
	}

#line 3250 "lib/network/McAsciiParser-gen.cpp"
	{
	if ( ( p_) == ( pe_) )
		goto _test_eof;
	if ( ( savedCs_) == 0 )
...
#line 96 "lib/network/McAsciiParser.rl"
  ...
  {( p_)++; goto _out; }
	...
	goto _again;
f2:
#line 123 "lib/network/McAsciiParser.rl"
	{
...
#line 271 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_stored); }
	goto _again;
f1:
#line 123 "lib/network/McAsciiParser.rl"
...
#line 283 "lib/network/McAsciiParser.rl"

}

// McVersion reply.

#line 3884 "lib/network/McAsciiParser-gen.cpp"
...
#line 296 "lib/network/McAsciiParser.rl"
...
#line 3900 "lib/network/McAsciiParser-gen.cpp"
	{
	}

#line 3904 "lib/network/McAsciiParser-gen.cpp"
	{
	if ( ( p_) == ( pe_) )
		goto _test_eof;
	if ( ( savedCs_) == 0 )
...
#line 167 "lib/network/McAsciiParser.rl"
	...
	goto _again;
f15:
#line 291 "lib/network/McAsciiParser.rl"
...
#line 306 "lib/network/McAsciiParser.rl"

}

// McDelete reply.

#line 4480 "lib/network/McAsciiParser-gen.cpp"
...
#line 318 "lib/network/McAsciiParser.rl"
...
#line 4496 "lib/network/McAsciiParser-gen.cpp"
	{
	}

#line 4500 "lib/network/McAsciiParser-gen.cpp"
	{
	if ( ( p_) == ( pe_) )
		goto _test_eof;
	if ( ( savedCs_) == 0 )
...
#line 328 "lib/network/McAsciiParser.rl"

}

//McMetaget reply.

#line 5110 "lib/network/McAsciiParser-gen.cpp"
...
#line 371 "lib/network/McAsciiParser.rl"
...
#line 5126 "lib/network/McAsciiParser-gen.cpp"
	{
	}

#line 5130 "lib/network/McAsciiParser-gen.cpp"
	{
	if ( ( p_) == ( pe_) )
		goto _test_eof;
	if ( ( savedCs_) == 0 )
...
#line 167 "lib/network/McAsciiParser.rl"
	...
	goto _again;
f15:
#line 336 "lib/network/McAsciiParser.rl"
	{
  reply.setNumber(static_cast<uint32_t>(currentUInt_));
}
	goto _again;
f19:
#line 339 "lib/network/McAsciiParser.rl"
	{
  reply.setNumber(static_cast<uint32_t>(-1));
}
	goto _again;
f16:
#line 342 "lib/network/McAsciiParser.rl"
	{
  reply.setExptime(static_cast<uint32_t>(currentUInt_));
}
	goto _again;
f17:
#line 345 "lib/network/McAsciiParser.rl"
	{
  ...
  if (reply.valueData_->length() < 46) {
	...
	goto _again;
f12:
#line 363 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_found); }
	goto _again;
f0:
#line 367 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_notfound); }
	goto _again;
f13:
#line 106 "lib/network/McAsciiParser.rl"
...
#line 381 "lib/network/McAsciiParser.rl"

}

// McFlushAll reply.

#line 6124 "lib/network/McAsciiParser-gen.cpp"
...
#line 393 "lib/network/McAsciiParser.rl"
...
#line 6140 "lib/network/McAsciiParser-gen.cpp"
	{
	}

#line 6144 "lib/network/McAsciiParser-gen.cpp"
	{
	if ( ( p_) == ( pe_) )
		goto _test_eof;
	if ( ( savedCs_) == 0 )
...
#line 167 "lib/network/McAsciiParser.rl"
	...
	goto _again;
f0:
#line 389 "lib/network/McAsciiParser.rl"
	{ reply.setResult(mc_res_ok); }
	goto _again;
f10:
#line 106 "lib/network/McAsciiParser.rl"
...
#line 403 "lib/network/McAsciiParser.rl"
